...
describe("App basic", () => {
  it("renders stats and table headers", () => {
    ...
    expect(within(thead).getByText(/Jobsite Name/i)).toBeInTheDocument();
    expect(within(thead).getByText(/Status/i)).toBeInTheDocument();

    expect(within(tbody).getByText(/Completed/i)).toBeInTheDocument();
    expect(within(tbody).getByText(/On Hold/i)).toBeInTheDocument();
